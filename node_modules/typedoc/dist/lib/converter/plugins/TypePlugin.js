...
let TypePlugin = class TypePlugin extends components_1.ConverterComponent {
    ...
    onResolve(context, reflection) {
        ...
        if (reflection.kindOf(index_1.ReflectionKind.ClassOrInterface)) {
            ...
            walk(reflection.implementedTypes, (target) => {
                ...
                target.implementedBy.push(new index_2.ReferenceType(reflection.name, index_2.ReferenceType.SYMBOL_FQN_RESOLVED, reflection));
            });
            walk(reflection.extendedTypes, (target) => {
                ...
                target.extendedBy.push(new index_2.ReferenceType(reflection.name, index_2.ReferenceType.SYMBOL_FQN_RESOLVED, reflection));
            });
        }
        ...
        function resolveType(reflection, type) {
            if (type instanceof index_2.ReferenceType) {
                if (type.symbolFullyQualifiedName === index_2.ReferenceType.SYMBOL_FQN_RESOLVE_BY_NAME) {
                    type.reflection = reflection.findReflectionByName(type.name);
                }
                else if (!type.reflection && type.symbolFullyQualifiedName !== index_2.ReferenceType.SYMBOL_FQN_RESOLVED) {
            ...
            else if (type instanceof index_2.TypeOperatorType) {
    ...
    onResolveEnd(context) {
        this.reflections.forEach((reflection) => {
            ...
            push([new index_2.ReferenceType(reflection.name, index_2.ReferenceType.SYMBOL_FQN_RESOLVED, reflection)]);
